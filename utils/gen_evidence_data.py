...
train_df[['start_token', 'end_token']] = train_df.apply(lambda x: calc_token_spans(x['question'], x['evidence'], x['answer']), axis=1, result_type='expand')
val_df[['start_token', 'end_token']] = val_df.apply(lambda x: calc_token_spans(x['question'], x['evidence'], x['answer']), axis=1, result_type='expand')
test_df[['start_token', 'end_token']] = test_df.apply(lambda x: calc_token_spans(x['question'], x['evidence'], x['answer']), axis=1, result_type='expand')
