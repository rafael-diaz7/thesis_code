...
class MultiLabelTokenClassificationMetrics():
    ...
    def macro_f1(y_true, y_pred):
        ...
        return K.sum([MultiLabelTokenClassificationMetrics.class_f1(y_true, y_pred, i) for i in range(
            MultiLabelTokenClassificationMetrics.num_classes)]) / MultiLabelTokenClassificationMetrics.num_classes
    ...
    def get_all_metrics(self):
        ...
        metrics = [  # MultiLabelTokenClassificationMetrics.num_neg,
            MultiLabelTokenClassificationMetrics.macro_precision, MultiLabelTokenClassificationMetrics.macro_recall,
            MultiLabelTokenClassificationMetrics.macro_f1,
            MultiLabelTokenClassificationMetrics.micro_precision, MultiLabelTokenClassificationMetrics.micro_recall,
            MultiLabelTokenClassificationMetrics.micro_f1]

        # add individual class metrics
        # there are at least 2 classes (always - positive and negative)
        metrics.extend(
            [MultiLabelTokenClassificationMetrics.precision_c0, MultiLabelTokenClassificationMetrics.recall_c0,
             MultiLabelTokenClassificationMetrics.f1_c0])
        metrics.extend(
            [MultiLabelTokenClassificationMetrics.precision_c1, MultiLabelTokenClassificationMetrics.recall_c1,
             MultiLabelTokenClassificationMetrics.f1_c1])
        if MultiLabelTokenClassificationMetrics.num_classes > 2:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c2, MultiLabelTokenClassificationMetrics.recall_c2,
                 MultiLabelTokenClassificationMetrics.f1_c2])
        if MultiLabelTokenClassificationMetrics.num_classes > 3:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c3, MultiLabelTokenClassificationMetrics.recall_c3,
                 MultiLabelTokenClassificationMetrics.f1_c3])
        if MultiLabelTokenClassificationMetrics.num_classes > 4:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c4, MultiLabelTokenClassificationMetrics.recall_c4,
                 MultiLabelTokenClassificationMetrics.f1_c4])
        if MultiLabelTokenClassificationMetrics.num_classes > 5:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c5, MultiLabelTokenClassificationMetrics.recall_c5,
                 MultiLabelTokenClassificationMetrics.f1_c5])
        if MultiLabelTokenClassificationMetrics.num_classes > 6:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c6, MultiLabelTokenClassificationMetrics.recall_c6,
                 MultiLabelTokenClassificationMetrics.f1_c6])
        if MultiLabelTokenClassificationMetrics.num_classes > 7:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c7, MultiLabelTokenClassificationMetrics.recall_c7,
                 MultiLabelTokenClassificationMetrics.f1_c7])
        if MultiLabelTokenClassificationMetrics.num_classes > 8:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c8, MultiLabelTokenClassificationMetrics.recall_c8,
                 MultiLabelTokenClassificationMetrics.f1_c8])
        if MultiLabelTokenClassificationMetrics.num_classes > 9:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c9, MultiLabelTokenClassificationMetrics.recall_c9,
                 MultiLabelTokenClassificationMetrics.f1_c9])
        if MultiLabelTokenClassificationMetrics.num_classes > 10:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c10, MultiLabelTokenClassificationMetrics.recall_c10,
                 MultiLabelTokenClassificationMetrics.f1_c10])
        if MultiLabelTokenClassificationMetrics.num_classes > 11:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c11, MultiLabelTokenClassificationMetrics.recall_c11,
                 MultiLabelTokenClassificationMetrics.f1_c11])
        if MultiLabelTokenClassificationMetrics.num_classes > 12:
            metrics.extend(
                [MultiLabelTokenClassificationMetrics.precision_c12, MultiLabelTokenClassificationMetrics.recall_c12,
                 MultiLabelTokenClassificationMetrics.f1_c12])
...
class MultiClassTokenClassificationMetrics:
    ...
    def macro_f1(y_true, y_pred):
        return K.sum([MultiClassTokenClassificationMetrics.class_f1(y_true, y_pred, i) for i in range(1,
                                                                                                      MultiClassTokenClassificationMetrics.num_classes)]) / MultiClassTokenClassificationMetrics.num_classes
    ...
    def get_all_metrics(self):
        ...
        metrics = [  # MultiClassTokenClassificationMetrics.num_neg,
            MultiClassTokenClassificationMetrics.macro_precision, MultiClassTokenClassificationMetrics.macro_recall,
            MultiClassTokenClassificationMetrics.macro_f1,
            MultiClassTokenClassificationMetrics.micro_precision, MultiClassTokenClassificationMetrics.micro_recall,
            MultiClassTokenClassificationMetrics.micro_f1]

        # add individual class metrics
        # there are at least 2 classes (always - positive and negative)
        metrics.extend(
            [MultiClassTokenClassificationMetrics.precision_c0, MultiClassTokenClassificationMetrics.recall_c0,
             MultiClassTokenClassificationMetrics.f1_c0])
        metrics.extend(
            [MultiClassTokenClassificationMetrics.precision_c1, MultiClassTokenClassificationMetrics.recall_c1,
             MultiClassTokenClassificationMetrics.f1_c1])
        if MultiClassTokenClassificationMetrics.num_classes > 2:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c2, MultiClassTokenClassificationMetrics.recall_c2,
                 MultiClassTokenClassificationMetrics.f1_c2])
        if MultiClassTokenClassificationMetrics.num_classes > 3:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c3, MultiClassTokenClassificationMetrics.recall_c3,
                 MultiClassTokenClassificationMetrics.f1_c3])
        if MultiClassTokenClassificationMetrics.num_classes > 4:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c4, MultiClassTokenClassificationMetrics.recall_c4,
                 MultiClassTokenClassificationMetrics.f1_c4])
        if MultiClassTokenClassificationMetrics.num_classes > 5:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c5, MultiClassTokenClassificationMetrics.recall_c5,
                 MultiClassTokenClassificationMetrics.f1_c5])
        if MultiClassTokenClassificationMetrics.num_classes > 6:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c6, MultiClassTokenClassificationMetrics.recall_c6,
                 MultiClassTokenClassificationMetrics.f1_c6])
        if MultiClassTokenClassificationMetrics.num_classes > 7:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c7, MultiClassTokenClassificationMetrics.recall_c7,
                 MultiClassTokenClassificationMetrics.f1_c7])
        if MultiClassTokenClassificationMetrics.num_classes > 8:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c8, MultiClassTokenClassificationMetrics.recall_c8,
                 MultiClassTokenClassificationMetrics.f1_c8])
        if MultiClassTokenClassificationMetrics.num_classes > 9:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c9, MultiClassTokenClassificationMetrics.recall_c9,
                 MultiClassTokenClassificationMetrics.f1_c9])
        if MultiClassTokenClassificationMetrics.num_classes > 10:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c10, MultiClassTokenClassificationMetrics.recall_c10,
                 MultiClassTokenClassificationMetrics.f1_c10])
        if MultiClassTokenClassificationMetrics.num_classes > 11:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c11, MultiClassTokenClassificationMetrics.recall_c11,
                 MultiClassTokenClassificationMetrics.f1_c11])
        if MultiClassTokenClassificationMetrics.num_classes > 12:
            metrics.extend(
                [MultiClassTokenClassificationMetrics.precision_c12, MultiClassTokenClassificationMetrics.recall_c12,
                 MultiClassTokenClassificationMetrics.f1_c12])
...
class MyMultiLabelTextClassificationMetrics:
    ...
    def get_all_metrics(self):
        ...
        metrics = [MyMultiLabelTextClassificationMetrics.num_neg,
                   MyMultiLabelTextClassificationMetrics.macro_precision,
                   MyMultiLabelTextClassificationMetrics.macro_recall, MyMultiLabelTextClassificationMetrics.macro_f1,
                   MyMultiLabelTextClassificationMetrics.micro_precision,
                   MyMultiLabelTextClassificationMetrics.micro_recall, MyMultiLabelTextClassificationMetrics.micro_f1]

        # add individual class metrics
        # there are at least 2 classes (always)
        metrics.extend(
            [MyMultiLabelTextClassificationMetrics.precision_c0, MyMultiLabelTextClassificationMetrics.recall_c0,
             MyMultiLabelTextClassificationMetrics.f1_c0])
        metrics.extend(
            [MyMultiLabelTextClassificationMetrics.precision_c1, MyMultiLabelTextClassificationMetrics.recall_c1,
             MyMultiLabelTextClassificationMetrics.f1_c1])
        if MyMultiLabelTextClassificationMetrics.num_classes > 2:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c2, MyMultiLabelTextClassificationMetrics.recall_c2,
                 MyMultiLabelTextClassificationMetrics.f1_c2])
        if MyMultiLabelTextClassificationMetrics.num_classes > 3:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c3, MyMultiLabelTextClassificationMetrics.recall_c3,
                 MyMultiLabelTextClassificationMetrics.f1_c3])
        if MyMultiLabelTextClassificationMetrics.num_classes > 4:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c4, MyMultiLabelTextClassificationMetrics.recall_c4,
                 MyMultiLabelTextClassificationMetrics.f1_c4])
        if MyMultiLabelTextClassificationMetrics.num_classes > 5:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c5, MyMultiLabelTextClassificationMetrics.recall_c5,
                 MyMultiLabelTextClassificationMetrics.f1_c5])
        if MyMultiLabelTextClassificationMetrics.num_classes > 6:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c6, MyMultiLabelTextClassificationMetrics.recall_c6,
                 MyMultiLabelTextClassificationMetrics.f1_c6])
        if MyMultiLabelTextClassificationMetrics.num_classes > 7:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c7, MyMultiLabelTextClassificationMetrics.recall_c7,
                 MyMultiLabelTextClassificationMetrics.f1_c7])
        if MyMultiLabelTextClassificationMetrics.num_classes > 8:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c8, MyMultiLabelTextClassificationMetrics.recall_c8,
                 MyMultiLabelTextClassificationMetrics.f1_c8])
        if MyMultiLabelTextClassificationMetrics.num_classes > 9:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c9, MyMultiLabelTextClassificationMetrics.recall_c9,
                 MyMultiLabelTextClassificationMetrics.f1_c9])
        if MyMultiLabelTextClassificationMetrics.num_classes > 10:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c10, MyMultiLabelTextClassificationMetrics.recall_c10,
                 MyMultiLabelTextClassificationMetrics.f1_c10])
        if MyMultiLabelTextClassificationMetrics.num_classes > 11:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c11, MyMultiLabelTextClassificationMetrics.recall_c11,
                 MyMultiLabelTextClassificationMetrics.f1_c11])
        if MyMultiLabelTextClassificationMetrics.num_classes > 12:
            metrics.extend(
                [MyMultiLabelTextClassificationMetrics.precision_c12, MyMultiLabelTextClassificationMetrics.recall_c12,
                 MyMultiLabelTextClassificationMetrics.f1_c12])
...
class MyMultiClassTextClassificationMetrics:
    ...
    def micro_recall(y_true, y_pred):
        ...
        true_positives = K.sum(rep * y_true[:,
                                     1:])  # TODO - haven't tested this [1:,:] part, same with range(1,..) in the macro, and the -1 from macro. Also, see micro_precision
    ...
    def get_all_metrics(self):
        ...
        metrics = [MyMultiClassTextClassificationMetrics.num_neg,
                   MyMultiClassTextClassificationMetrics.macro_precision,
                   MyMultiClassTextClassificationMetrics.macro_recall, MyMultiClassTextClassificationMetrics.macro_f1,
                   MyMultiClassTextClassificationMetrics.micro_precision,
                   MyMultiClassTextClassificationMetrics.micro_recall, MyMultiClassTextClassificationMetrics.micro_f1]

        # add individual class metrics
        # there are at least 2 classes (always)
        metrics.extend(
            [MyMultiClassTextClassificationMetrics.precision_c0, MyMultiClassTextClassificationMetrics.recall_c0,
             MyMultiClassTextClassificationMetrics.f1_c0])
        metrics.extend(
            [MyMultiClassTextClassificationMetrics.precision_c1, MyMultiClassTextClassificationMetrics.recall_c1,
             MyMultiClassTextClassificationMetrics.f1_c1])
        if MyMultiClassTextClassificationMetrics.num_classes > 2:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c2, MyMultiClassTextClassificationMetrics.recall_c2,
                 MyMultiClassTextClassificationMetrics.f1_c2])
        if MyMultiClassTextClassificationMetrics.num_classes > 3:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c3, MyMultiClassTextClassificationMetrics.recall_c3,
                 MyMultiClassTextClassificationMetrics.f1_c3])
        if MyMultiClassTextClassificationMetrics.num_classes > 4:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c4, MyMultiClassTextClassificationMetrics.recall_c4,
                 MyMultiClassTextClassificationMetrics.f1_c4])
        if MyMultiClassTextClassificationMetrics.num_classes > 5:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c5, MyMultiClassTextClassificationMetrics.recall_c5,
                 MyMultiClassTextClassificationMetrics.f1_c5])
        if MyMultiClassTextClassificationMetrics.num_classes > 6:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c6, MyMultiClassTextClassificationMetrics.recall_c6,
                 MyMultiClassTextClassificationMetrics.f1_c6])
        if MyMultiClassTextClassificationMetrics.num_classes > 7:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c7, MyMultiClassTextClassificationMetrics.recall_c7,
                 MyMultiClassTextClassificationMetrics.f1_c7])
        if MyMultiClassTextClassificationMetrics.num_classes > 8:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c8, MyMultiClassTextClassificationMetrics.recall_c8,
                 MyMultiClassTextClassificationMetrics.f1_c8])
        if MyMultiClassTextClassificationMetrics.num_classes > 9:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c9, MyMultiClassTextClassificationMetrics.recall_c9,
                 MyMultiClassTextClassificationMetrics.f1_c9])
        if MyMultiClassTextClassificationMetrics.num_classes > 10:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c10, MyMultiClassTextClassificationMetrics.recall_c10,
                 MyMultiClassTextClassificationMetrics.f1_c10])
        if MyMultiClassTextClassificationMetrics.num_classes > 11:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c11, MyMultiClassTextClassificationMetrics.recall_c11,
                 MyMultiClassTextClassificationMetrics.f1_c11])
        if MyMultiClassTextClassificationMetrics.num_classes > 12:
            metrics.extend(
                [MyMultiClassTextClassificationMetrics.precision_c12, MyMultiClassTextClassificationMetrics.recall_c12,
                 MyMultiClassTextClassificationMetrics.f1_c12])
